...
public class UploadProductActivity extends AppCompatActivity {
    ...
    private void uploadData(String userId) {
        ...
        StorageReference filePath = mStorage.child("category").child(userId).child("images").child(imageUri.getLastPathSegment());
                    ...
                    filePath.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                DatabaseReference userServicesRef = mDatabase.child("category").child("serviceName");
